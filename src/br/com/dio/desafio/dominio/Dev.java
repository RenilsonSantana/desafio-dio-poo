...
public class Dev {
	...
	public void concluirBootcamp() {
		if(!this.conteudosInscritos.isEmpty()) {
			this.conteudosConcluidos.addAll(conteudosInscritos);
			this.conteudosInscritos.removeAll(conteudosInscritos);
		} else {
			System.out.println("Não há nenhum bootcamp pendente!");
		}
	}
